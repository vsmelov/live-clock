...
```
          ┌─────────────────────────────┐
          │         17310 дней          │  ← пересчитывается раз в 15–30 минут
          │          1:56:26            │  ← тикает секундами сам
...
Действий одиннадцать. В приложении они идут списком с поиском: искать можно
...
Сутки и `Ч:ММ:СС` разделены не для красоты: `Chronometer` форматирует время
